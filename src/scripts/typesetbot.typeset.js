TypesetBot.typeset = (function(obj, $) {
    ...
    obj.typesetParagraph = function (elem, settings) {
        ...
        while (! vars.done) {
            ...
            while (! lineVars.done) {
                ...
                var word = appendWord(vars, lineVars, finalBreaks);
                    ...
                    word.index.forEach(function (wordIndex) {
                        ...
                        node.hyphenIndex.forEach(function (hyphenIndex, key) {
                            ...
                            if (TypesetBot.math.validRatio(hyphenRatio, settings)) {
                                ...
                                var demerit = TypesetBot.math.calcDemerit(hyphenRatio, 50, true, settings);
                                ...
                                activeBreakpoints.enqueue(breakNode);
                                breakpoints.push(breakNode);
        ...
        applyBreaks(elem, vars.nodes, finalBreaks);
    ...
    function appendWord(vars, lineVars, finalBreaks) {
        var done = false,
            word = '',
            wordIndex = [];
        ...
        while (! done) {
            ...
            if (node == null) { // Possible final break
                ...
                finalBreaks.push(TypesetBot.node.createBreak(
                    wordIndex - 1,
                    null,
                    lineVars.origin,
            ...
            if (node.type === 'word') {
                ...
                if (lineVars.line == 1) { // Debug
                    console.log('w: --> %s', lineVars.curWidth);
                }
